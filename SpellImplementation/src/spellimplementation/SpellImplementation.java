...
public class SpellImplementation extends UnicastRemoteObject implements SpellingInterface {
    ...
    public SpellImplementation(String file) throws RemoteException,IOException {
